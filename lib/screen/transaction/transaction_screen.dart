  ...
  void initState() {
    Future.delayed(Duration.zero).then((value) async {
      ...
      Provider.of<TransactionProvider>(context, listen: false)
          .fnInitStatusOrder();
      Provider.of<TransactionProvider>(context, listen: false)
          .fnFetchTransactionList();
      Provider.of<TransactionProvider>(context, listen: false)
          .fnOnReceiveNotification();
            ...
            child: Container(
              ...
              child: SfDateRangePicker(
                ...
                onSelectionChanged: (value) async =>
                    await _provider.fnOnSelectCustomDate(value, flag),
              ),
            ),
          );
        },
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return RadioListTile(
                                ...
                                onChanged: (value) =>
                                    provider.fnOnSelectDateFilter(index),
                              );
                            },
                          ),
                        );
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () =>
                                                _showDatePickerDialog('from'),
                                            child: TextFormField(
                                              enabled: false,
                                              controller:
                                                  _provider.fromDateController,
                                              keyboardType:
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () =>
                                                _showDatePickerDialog('to'),
                                            child: TextFormField(
                                              enabled: false,
                                              controller:
                                                  _provider.toDateController,
                                              keyboardType:
                                                  TextInputType.number,
                                              textInputAction:
                                                  TextInputAction.next,
    ...
    Widget _tabBar = Consumer<TransactionProvider>(
      builder: (context, provider, _) {
        return TabBar(
          ...
          onTap: (value) =>
              _provider.fnOnTabSelected(provider.tabLabel[value].id),
        );
      },
    );
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    provider.fnGetStatus(_data
                                                            ?.idStatusPayment ??
                                                        0),
                                                    style: TextStyle(
                                                      color: provider.fnGetStatus(
                                                                  _data?.idStatusPayment ??
                                                                      0) ==
                                                              AppLocalizations
                                                                  .instance
                                                                  .text(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  if (_data?.idStatusPayment ==
                                                      1)

                                                    /// Waiting for payment
                                                    if (_data?.paymentMethod ==
                                                        'transfer_manual')
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                AppLocalizations.instance.text('TXT_HEADER_TRANSACTION'),
                style: TextStyle(
