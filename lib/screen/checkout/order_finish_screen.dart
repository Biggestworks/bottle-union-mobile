                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4,),
                        Text('Your order ID ${_data?.idOrder} has been placed', style: TextStyle(
                          fontSize: 14,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Flexible(
                            child: Text('${_data?.courierName ?? '-'} ${_data?.courierEtd ?? '-'} (${FormatterHelper.moneyFormatter(int.parse(_data?.courierCost ?? '0'))})', style: TextStyle(
                              color: Colors.black,
                            )),
                          ),
                        ],
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(provider.fnGetTotalPrice(_data?.amount ?? 0, int.parse(_data?.courierCost ?? '0'))),
                          ),
                        ],
                      ),
                      Divider(height: 20, thickness: 1,),
                      Row(
                        ...
                        children: [
                          Text('Delivery Cost'),
                          Flexible(
                            child: Text(FormatterHelper.moneyFormatter(int.parse(_data?.courierCost ?? '0'))),
                          ),
                        ],
                      ),
                      Divider(height: 20, thickness: 1,),
