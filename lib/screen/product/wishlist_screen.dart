  ...
  Widget build(BuildContext context) {
                    ...
                    switch (provider.wishlist.result!.data!.length) {
                      case 0:
                        return CustomWidget.emptyScreen(
                          ...
                          size: 180,
                          title:
                              AppLocalizations.instance.text('TXT_NO_WISHLIST'),
                          action: SizedBox(
                            width: 150,
                          ...
                          child: ListView(
                            ...
                            children: [
                              ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount:
                                    provider.wishlist.result?.data?.length,
                                itemBuilder: (context, index) {
                                  var _data =
                                      provider.wishlist.result?.data?[index];
                                  return Row(
                                    children: [
                                      AnimatedSwitcher(
                                        duration:
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                children: [
                                                                  RatingBar
                                                                      .builder(
                                                                    initialRating: double.parse(_data
                                                                            ?.product
                                                                            ?.rating ??
                                                                        '0.0'),
                                                                    ignoreGestures:
                  ...
                  switch (provider.wishlist.result!.data!.length) {
                    ...
                    default:
                      return Row(
                        ...
                        children: [
                          Text(
                            '${provider.wishlist.result!.total ?? '0'}'
                            '${AppLocalizations.instance.text('TXT_WISHLIST_TOTAL')}',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
          ...
          function: () async {
            ...
            if (_provider.idList.isNotEmpty) {
              CustomWidget.showConfirmationDialog(
                context,
                desc:
                    AppLocalizations.instance.text('TXT_REMOVE_WISHLIST_INFO'),
                function: () async {
                  await fnStoreLog(
                  ...
                  await _provider.fnDeleteMultiWishlist(
              ...
              CustomWidget.showSnackBar(
                context: context,
                content: Text(
                    AppLocalizations.instance.text('TXT_SELECT_ITEM_INFO')),
              );
            }
          },
        ),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Consumer<WishListProvider>(
        child: SizedBox(),
        builder: (context, provider, skeleton) {
          if (provider.isSelection &&
              (provider.wishlist.result?.data?.length ?? 0) > 0) {
            return _submitBtn;
          } else {
            return SizedBox();
          }
